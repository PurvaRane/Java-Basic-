...
public class UniversityForm extends Frame implements ActionListener{
Label l1,l2,l3,l4
...
Checkbox c2 = new Checkbox("Female",cbg,true);
    c1.setBounds(160,240,50,50);
    c2.setBounds(240,240,50,50);
    add(c1);
    add(c2);
//team 
...
Checkbox cb = new Checkbox("Tech",null,false);
    ...
    cb.setBounds(160, 290,50 , 50);
    add(cb);
    cb1.setBounds(230, 290,70 , 50);
    add(cb1);
    cb2.setBounds(300, 290,50 , 50);
    add(cb2);
    //subject
...
public void addActionPerformed(ActionEvent a){
    t.setText("Your Form is Submitted ");
